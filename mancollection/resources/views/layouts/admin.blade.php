                ...
                if (searchQuery.length > 2) {
                    $.ajax({
                        ...
                        success: function(data) {
                            $("#box-content-search").empty(); // Clear the search results box

                            if (data.length > 0) {
                                $.each(data, function(index, item) {
                                    var url =
                                        "{{ route('admin.products.edit', ['id' => 'product_id']) }}";
                                    var link = url.replace('product_id', item
                                        .id);
                    ...
                    $("#box-content-search")
                        .empty(); // Clear the search results if query is less than 3 characters
                }
            });
        });
    </script>
