...
@section('content')
    <style>
        .slideshow-text h2:hover,
        .slideshow-text p:hover,
        .slideshow-text a.btn:hover {
            transform: scale(1.1);
            /* Enlarge the text and button */
                    ...
                    <div class="accordion-item mb-4 pb-3">
                        ...
                        <div id="accordion-filter-1" class="accordion-collapse collapse show border-0"
                            ...
                            <div class="accordion-body px-0 pb-0 pt-3 category-list">
                                <ul class="list list-inline mb-8">
                    ...
                    <div class="accordion-item mb-4 pb-3">
                        ...
                        <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
                            ...
                            <div class="search-field multi-select accordion-body px-0 pb-0">
                                <ul class="list list-inline mb-e brand-list">
            ...
            <div class="shop-list flex-grow-1">
                <div class="swiper-container js-swiper-slider slideshow slideshow_small slideshow_split"
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="slide-split h-100 d-block d-md-flex overflow-hidden position-relative">
                                <div class="slideshow-bg d-flex align-items-center justify-content-end"
                                    style="background-color: #000; width: 100%;">
                                    <img loading="lazy" src="{{ asset('images/shop/shop_banner.png') }}"
                                        alt="Women's accessories" class="slideshow-bg__img object-fit-cover"
                                        style="width: 100%; height: 100%; object-position: center right;" />
                                </div>
                                <div class="slideshow-text container p-3 p-xl-5 position-absolute h-100 d-flex flex-column justify-content-center"
                                    style="left: 0;">
                                    <h2 class="text-uppercase section-title fw-normal mb-3 text-white animate animate_fade animate_btt animate_delay-2"
                                        style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.7);">
                                        Women's <br /><strong>ACCESSORIES</strong>
                                    </h2>
                                    <p class="mb-0 text-white animate animate_fade animate_btt animate_delay-5"
                                        style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.7);">
                                        Accessories are the best way to update your look.<br /> Add a title edge with new
                                        styles
                                        and new <br />colors, or go for timeless pieces.
                                    </p>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="slide-split h-100 d-block d-md-flex overflow-hidden position-relative">
                                <div class="slideshow-bg d-flex align-items-center justify-content-end"
                                    style="background-color: #000; width: 100%;">
                                    <img loading="lazy" src="{{ asset('images/shop/shop_banner7.png') }}"
                                        alt="Women's accessories" class="slideshow-bg__img object-fit-cover"
                                        style="width: 100%; height: 100%; object-position: center right;" />
                                </div>
                                <div class="slideshow-text container p-3 p-xl-5 position-absolute h-100 d-flex flex-column justify-content-center align-items-center text-center"
                                    style="left: 0;">
                                    <h2 class="text-uppercase section-title fw-normal mb-3 text-white animate animate_fade animate_btt animate_delay-2"
                                        style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.7); font-size: 2.5rem; transition: transform 0.3s ease, background-color 0.3s ease;">
                                        Women's <br /><strong>ACCESSORIES</strong>
                                    </h2>
                                    <p class="mb-4 text-white animate animate_fade animate_btt animate_delay-5"
                                        style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.7); font-size: 1.25rem; transition: transform 0.3s ease, background-color 0.3s ease;">
                                        Accessories are the best way to update your look.<br /> Add a title edge with new
                                        styles and new<br />colors, or go for timeless pieces.
                                    </p>
                                    <a href="{{ route('shop.index') }}" class="btn btn-light text-uppercase px-4 py-2"
                                        style="font-size: 1rem; transition: transform 0.3s ease, background-color 0.3s ease;">
                                        Order Now
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="slide-split h-100 d-block d-md-flex overflow-hidden position-relative">
                                <div class="slideshow-bg d-flex align-items-center justify-content-end"
                                    style="background-color: #000; width: 100%;">
                                    <img loading="lazy" src="{{ asset('images/shop/shop_banner5.png') }}"
                                        alt="Women's accessories" class="slideshow-bg__img object-fit-cover"
                                        style="width: 100%; height: 100%; object-position: center right;" />
                                </div>
                                <div class="slideshow-text container p-3 p-xl-5 position-absolute h-100 d-flex flex-column justify-content-center"
                                    ...
                                    <h2 class="text-uppercase section-title fw-normal mb-3 text-white animate animate_fade animate_btt animate_delay-2"
                                        style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.7);">
                                        Men's <br /><strong>ACCESSORIES</strong>
                                    </h2>
                                    <p class="mb-0 text-white animate animate_fade animate_btt animate_delay-5"
                                        style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.7);">
                                        Accessories are the best way to update your look.<br /> Add a title edge with new
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            aria-label="Sort Items" name="orderby" id="orderby" style="margin-right: 10px">
                        ...
                        <div class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"></div>
                                ...
                                <div class="pc__img-wrapper">
                                    <div class="swiper-container background-img js-swiper-slider"
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <a
                                                    href="{{ route('shop.products.details', ['product_slug' => $product->slug]) }}">
                                                    <img loading="lazy"
                                            ...
                                            @if ($product->images)
                                                @foreach (array_filter(array_map('trim', explode(',', $product->images))) as $gimg)
                                                    @php
                                                        $cleanImg = trim($gimg, '[]"'); // Clean the filename
                                                        $imageUrl = asset('uploads/products/' . $cleanImg); // Construct the image URL
                                                    @endphp
                                                    <div class="swiper-slide">
                                                        <a
                                                            href="{{ route('shop.products.details', ['product_slug' => $product->slug]) }}">
                                                            <img loading="lazy" src="{{ $imageUrl }}" width="330"
...
@section('script')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            var swiperContainers = document.querySelectorAll('.js-swiper-slider');

            swiperContainers.forEach(function(container) {
                if (container) {
                    var prevButton = container.querySelector('.pc__img-prev');
                    var nextButton = container.querySelector('.pc__img-next');
                        ...
                        new Swiper(container, {
                            ...
                            on: {
                                imagesReady: function() {
                                    console.log('Swiper images are ready');
                                },
